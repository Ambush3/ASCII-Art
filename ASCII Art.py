...
img = Image.open(r"L:\steam av\Taco Bell.jpg")
...
def getAverageL(image):
    """
    Given PIL Image, return avg value of grayscale value
    """
...
def covertImagetoASCII(fileName, cols, scale, moreLevels):
    ...
    # an ASCII image is a list of char. strings
    aimg = []
    ...
    for j in range(rows):
        ...
        for i in range(cols):
            ...
            #append the ASCII char to the string
            aimg[j] += gsval
...
def main():
    ...
    f = open(outFile, 'w')
    # write each string i nteh list to the new file
    for row in aimg:
        f.write(row + '\n')
    # clean up
    f.close()
